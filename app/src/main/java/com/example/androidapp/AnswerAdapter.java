...
public class AnswerAdapter extends RecyclerView.Adapter<AnswerAdapter.MyViewHolder> {
    ...
    AnswerAdapter(Context context, ArrayList poll_id, ArrayList poll_name, ArrayList poll_time, ArrayList poll_btn, String userName) {
    ...
    public void onBindViewHolder(@NonNull AnswerAdapter.MyViewHolder holder, int position) {
        ...
        holder.poll_btn_txt.setText("Answers");
        ...
        holder.poll_btn_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), ShowAnswersUser.class);
